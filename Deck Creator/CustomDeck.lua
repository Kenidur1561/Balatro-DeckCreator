...
function CustomDeck:blankDeck()
    ...
    o.config = {
        ...
        standard_pack_p_edition_rate = 2,
...
function CustomDeck:fullNew(name, loc_txt, dollars, handSize, discards, hands, reRollCost, jokerSlots, anteScaling, consumableSlots, dollarsPerHand, dollarsPerDiscard, jokerRate, tarotRate, planetRate, spectralRate, playingCardRate, randomizeRankSuit, noFaces, interestAmount, interestCap, discountPercent, p_edition, doubleTag, balanceChips, p_editionCount, deckBackIndex, winAnte, inflation, shopSlots,
                            ...
                            random_polychrome_cards, random_holographic_cards, random_foil_cards, random_p_edition_cards, random_bonus_cards, random_glass_cards, random_lucky_cards, random_steel_cards, random_stone_cards,
                            ...
                            p_edition_rate, spectral_cards_in_arcana, always_telescoping, allow_black_hole, allow_soul, never_telescoping,
                            ...
                            standard_pack_p_edition_rate, standard_pack_enhancement_rate, standard_pack_seal_rate,
    ...
    o.config = {
        ...
        standard_pack_p_edition_rate = standard_pack_p_edition_rate,
        ...
        random_p_edition_cards = random_p_edition_cards,
...
function CustomDeck.fullNewFromExisting(deck, descTable, updateUUID)
    ...
    return CustomDeck:fullNew(
            ...
            deck.config.p_edition,
            deck.config.double_tag,
            deck.config.balance_chips,
            deck.config.p_edition_count,
            ...
            deck.config.random_p_edition_cards,
            ...
            deck.config.standard_pack_p_edition_rate,
